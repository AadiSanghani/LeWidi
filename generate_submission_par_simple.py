...
from train_par_simple import ParSimpleModel
...
def main(args):
    ...
    num_classes = metadata.get('training_config', {}).get('num_classes', 11)
    ...
    print("  zip -j paraphrase_simple_submission.zip *.tsv")
