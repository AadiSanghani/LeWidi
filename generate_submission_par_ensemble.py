...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate submission TSV for Paraphrase dataset using Ensemble RoBERTa + Multiple Models + Demographics.")
    parser.add_argument("--model_dir", type=str, required=True, help="Path to fine-tuned ensemble model directory (containing pytorch_model.bin)")
