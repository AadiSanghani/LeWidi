...
class VariErrNLIDemogModel(torch.nn.Module):
    """RoBERTa-Large model with demographic embeddings for annotator-aware NLI."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune RoBERTa-Large with demographic embeddings on VariErr NLI using cross-entropy loss with soft labels.")
